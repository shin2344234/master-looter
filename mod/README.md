...
1. Take [docs/MasterLooter.template.txt](../docs/MasterLooter.template.txt), which holds all 309 strings. It is generated from the source by `scripts/make_translation_template.py`, so it covers the whole menu.
