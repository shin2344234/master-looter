...
namespace ml::gui
{
    ...
    static void TabLooting(Config& c)
    {
        ...
        const Toggle toggles[] = {
            ...
            { "Plants",         &c.gatherPlants,   "Herb, flower and mushroom nodes, and the same lying on the ground, seeds included. Food crops have their own switch. To keep the herbs and leave the seeds, or the other way round, refuse the class on the Classes tab: herb and seed are separate there. That sorts what is lying on the ground item by item and does not reach the node itself. Only 17 of the 141 plant nodes say what they hold, and those have paid grain and crafting materials as well as herbs, so no class rule can speak for the rest. A plant node answers to this switch alone." },
