...
One scanner out of sixty-three flags `MasterLooter.asi` on 1.6.12: Webroot, as `Win.Hacktool.Gen`, its generic name for anything shaped like a trainer. Microsoft had flagged every release from 1.2.1 to 1.6.10 with a `Trojan:Win32/Wacatac.C!ml` guess, where the `!ml` is a model reporting the shape of a file, and it has read the signed builds as clean since. Symantec and Cynet stopped at the first signed build. Webroot alone objects to the archives, one of sixty-eight, for the same file inside them.

The number moves release to release without the code changing character: 1.2.1 scored four, 1.4.0 four, 1.5.0 two, 1.5.1 four, 1.6.0 two, 1.6.1 three, 1.6.2 three, 1.6.3 three, 1.6.4 four, 1.6.5 four, 1.6.6 four, 1.6.7 three, 1.6.8 four, 1.6.9 four, 1.6.10, the first signed build, two, and 1.6.12 one. Microsoft flagged every one of them up to the signature, and Symantec every unsigned one. Everything else comes and goes: Deep Instinct has left, CrowdStrike Falcon stayed three releases and dropped off on 1.6.6, Cynet appeared on 1.6.4, was gone by 1.6.5, came back on 1.6.6, left on 1.6.7, returned on 1.6.9 and left again with the signature, Webroot arrived on 1.6.5, a build whose one change is that it no longer creates a Direct3D device at startup, and Elastic arrived on 1.6.8 and was gone again on 1.6.9. That is what a model guessing looks like, as against a scanner recognising something.

Reports for 1.6.12: [the plugin](https://www.virustotal.com/gui/file/e047ec887b56db4ee5ca81328a12f3ea39d61c3f914e8ed2083282b2da51359e) and [the package](https://www.virustotal.com/gui/file/78961f99d0e3fb3bd683b18f31a69c6ddb6714bf3b9c16fda10755497b532b1e).
