...
Brazilian Portuguese plus Simplified and Traditional Chinese ship with the mod. They are built into the plugin, so they survive a mod manager that deploys the .asi on its own, and each has a button under General, Language.
