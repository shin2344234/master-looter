...
#include <d3d12.h>
#include <dxgi1_4.h>
// Master Looter: the two shaders are precompiled DXBC (imgui_dx12_shaders.h),
// so this backend imports no d3dcompiler. Everything else is upstream
// v1.91.5-docking, unchanged.
...
bool    ImGui_ImplDX12_CreateDeviceObjects()
{
    ...
    // Create the vertex shader (precompiled; Master Looter)
    {
    ...
    // Create the pixel shader (precompiled; Master Looter)
    {
